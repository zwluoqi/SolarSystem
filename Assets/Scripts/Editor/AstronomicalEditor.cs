...
public class AstronomicalEditor : UnityEditor.Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        //
        //     speed = EditorGUILayout.FloatField("切线速度", speed);
        //     angle = EditorGUILayout.FloatField("角度", angle);
        //     
        //
        //     var rotation = Quaternion.AngleAxis(angle, Vector3.forward);
        ...
        //     
        //     
        //     my.InitVelocity = tangentDir.normalized * speed;
        //     
    ...
    public void OnSceneGUI()
    {
        ...
        foreach (var astronomical in _astronomicals)
        {
            if (astronomical != my)
            {
                var distance = Vector3.Distance(astronomical.transform.position, my.transform.position);
                ...
                Handles.Label(centerPos, distance + "M",guiSkin.label);
            }
        }
